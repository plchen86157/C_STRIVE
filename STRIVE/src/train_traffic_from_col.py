...
def parse_cfg():
    ...
    parser.add_argument(
        "--val_every", type=int, default=5, help="Number of epochs between validations."
    )
    parser.add_argument(
        "--save_every",
        type=int,
...
def run_one_epoch(
    ...
    for k, v in metrics.items():
        ...
        # print("Wandb Epoch Metrics:", wandb_epoch_metrics)
...
def main():
    ...
    print(cfg.future_len)
    print(cfg.use_challenge_splits)
