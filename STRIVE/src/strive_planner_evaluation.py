    ...
    for i, data in enumerate(pbar_data):
        ...
        try:
            ...
            if len(sol_graph_list) > 0:
                ...
                #################### Our scenario ##################################
                ####################################################################
                all_future_gt = scene_graph.future_gt.clone().detach()
                ####################################################################
                ...
                print("final_result_traj:", final_result_traj.shape) # 13, 1, 4, 4
                print("sol_amask:", sol_amask.shape) # 13
                print("sol_in_final_result_traj:", sol_in_final_result_traj.shape) # 13, 1, 4, 4
                ...
                print("sol_result_traj:", sol_result_traj.shape) # 13, 1, 4, 4
                print(sol_scene_graph.scene_name)
                exit()
